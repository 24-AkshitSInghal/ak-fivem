Scully = {
    ...
    ColourCommand = 'radioskin', -- Set to '' if you don't want to allow changing with a command, command is /rcolour 1-11
    ...
    UseKeybind = 'i', -- Set to '' if you don't want to use the radio as a keybind, can be changed here for first use only or in your fivem keybind settings
