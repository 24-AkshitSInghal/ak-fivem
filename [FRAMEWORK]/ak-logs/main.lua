    ...
    if data.players then
        if type(data.players) == "table" then
            ...
            for k,v in pairs(data.players) do
                ...
                local characterId = exports['coca_spawnmanager']:GetCharacterIdByServerId(""..v.id)
                
                print(v.id, characterId, GetPlayerName(v.id))
                table.insert(fields, {
                    name = "Name | Server ID | Character ID | role",
                    value = characterId and
                        (GetPlayerName(v.id) .. " [" .. v.id .. "] [" .. characterId .. "] [" .. v.role .. "]") or
                    (GetPlayerName(v.id) .. " [" .. v.id .. "] [" .. v.role .. "]"),
                    inline = true,
                })
    
                table.insert(fields, {
                    name = "Fivem licence Identifier",
