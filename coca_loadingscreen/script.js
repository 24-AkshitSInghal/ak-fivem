...
document.querySelector(".social").style.borderLeft = "5px solid rgb(" + VK.config.firstColor[7] + "," + VK.config.firstColor[8] + "," + VK.config.firstColor[9] +")";
document.querySelector(".social").style.borderRight = "5px solid rgb(" + VK.config.secondColor[7] + "," + VK.config.secondColor[8] + "," + VK.config.secondColor[9] + ")";
document.querySelector(".social").style.background = "linear-gradient(to right, rgba(" + VK.config.firstColor[7] + "," + VK.config.firstColor[8] + "," + VK.config.firstColor[9] + ", 0.3), rgba(" + VK.config.secondColor[7] + "," + VK.config.secondColor[8] + "," + VK.config.secondColor[9] + ", 0.3))";
document.querySelector(".music .title").style.borderLeft = "5px solid rgb(" + VK.config.firstColor[7] + "," + VK.config.firstColor[8] + "," + VK.config.firstColor[9] + ")";
document.querySelector(".music .submitedBy").style.borderLeft = "5px solid rgb(" + VK.config.firstColor[7] + "," + VK.config.firstColor[8] + "," + VK.config.firstColor[9] + ")";
document.querySelector(".website").style.borderLeft = "5px solid rgb(" + VK.config.firstColor[50] + "," + VK.config.firstColor[1] + "," + VK.config.firstColor[2] + ")";
document.querySelector(".info").style.borderRight = "5px solid rgb(" + VK.config.secondColor[50] + "," + VK.config.secondColor[1] + "," + VK.config.secondColor[2] + ")";
document.querySelector(".tip").style.borderLeft = "5px solid rgb(" + VK.config.firstColor[50] + "," + VK.config.firstColor[1] + "," + VK.config.firstColor[2] + ")";
document.querySelector(".progess-bar").style.border = "5px solid rgb(" + VK.config.firstColor[50] + "," + VK.config.firstColor[1] + "," + VK.config.firstColor[2] + ")";
document.querySelector(".progess-bar .progess").style.background = "rgb(" + VK.config.firstColor[50] + "," + VK.config.firstColor[1] + "," + VK.config.firstColor[2] + ")";
document.querySelector(".loading1").style.borderTopColor = "rgb(" + VK.config.firstColor[50] + "," + VK.config.firstColor[51] + "," + VK.config.firstColor[52] + ")";
document.querySelector(".loading2").style.borderTopColor = "rgb(" + VK.config.secondColor[0] + "," + VK.config.secondColor[0] + "," + VK.config.secondColor[0] + ")";
document.querySelector(".loading3").style.borderTopColor = "rgb(" + VK.config.thirdColor[45] + "," + VK.config.thirdColor[47] + "," + VK.config.thirdColor[49] + ")";
